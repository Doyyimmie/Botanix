...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(sc => sc.setName('submit').setDescription('Submit a suggestion')
      .addStringOption(o => o.setName('text').setDescription('Suggestion text').setRequired(true)))
    .addSubcommand(sc => sc.setName('list').setDescription('List recent suggestions')
      .addIntegerOption(o => o.setName('limit').setDescription('Number of suggestions to list').setRequired(false)))
    .addSubcommand(sc => sc.setName('handle').setDescription('Approve or deny a suggestion')
  ...
  async execute(interaction) {
    ...
    if (sub === 'handle') {
      ...
      s.handledBy = interaction.user.tag;
      s.handledAt = new Date();
      await s.save();
